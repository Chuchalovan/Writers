...
**«Манускрипт»** — рабочая среда для авторов художественной прозы: планирование, персонажи, мир, сюжет, части/главы/сцены, редактор и контекстный AI.

**MVP** = MVP Beta (P0 + P1). Scope при расхождении: [MVP Scope Matrix](../roadmap/MVP-SCOPE-MATRIX.md).
